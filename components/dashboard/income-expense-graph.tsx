                ...
                >
                  ...
                  {item.income > 0 && (
                    <>
                      ...
                      <div
                        className="w-full bg-accent border border-accent/40 rounded-t-lg shadow-sm hover:shadow-md transition-shadow duration-200 min-w-full"
                ...
                >
                  {item.expenses > 0 && (
                    <>
                      ...
                      <div
                        className="w-full bg-red-500 border border-red-500/50 rounded-b-lg shadow-sm hover:shadow-md transition-shadow duration-200 min-w-full"
